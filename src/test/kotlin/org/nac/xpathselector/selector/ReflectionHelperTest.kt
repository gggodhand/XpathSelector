...
import org.nac.xpathselector.selector.page.test.reflectionhelper.PageTestCls
import org.junit.jupiter.api.function.Executable
import org.nac.xpathselector.selector.page.test.reflectionhelper.PageTest
...
internal class ReflectionHelperTest: BaseSelectorTest() {
    ...
    fun `isObject should return true for objects`() {
        assertTrue(ReflectionHelper.isObject(org.nac.xpathselector.selector.page.PageTest::class.java))
    }

    @Test
    fun `isObject should return false for classes`() {
        assertFalse(ReflectionHelper.isObject(org.nac.xpathselector.selector.page.PageTestCls::class.java))
    }
